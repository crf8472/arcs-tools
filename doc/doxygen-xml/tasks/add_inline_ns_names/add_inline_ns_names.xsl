...
<!-- Add a specified namespace name -->
...
<!-- Match all class compounds whose names contain at least one namespace -->
<!-- but do not contain '::v_1_0_0'.                                      -->

<xsl:template match="compoundname[not(contains(text(),'::v_1_0_0')) and contains(text(),'::')]">
